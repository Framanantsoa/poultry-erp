<template>
  <div class="relative w-full">
    <textarea :id="id" :value="modelValue"
      ...
      :class="[
        'w-full px-4 py-3.5 text-gray-900 dark:text-white bg-transparent border rounded-lg focus:outline-none focus:ring-2 transition-all duration-200 peer resize-y',
    ...
    <!-- Character count -->
    <div v-if="maxlength" class="mt-1 text-xs text-right text-gray-400 dark:text-gray-500">
